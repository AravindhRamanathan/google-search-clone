  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen'>
      ...
      <header className='flex justify-between w-full p-5 text-sm text-gray-700 '>
        ...
        <AppsIcon className='h-10 w-10 p-2 rounded-full hover:bg-gray-100 cursor-pointer'/>
        <Avatar url="https://lh3.googleusercontent.com/a/AGNmyxaMFmd4gbGgsnV5uGvxC0uc_wf2dmP7by2G6ibtocY=s576"/>
        </div>
      ...
      px-5 py-3 items-center sm:max-w-xl lg:max-w-2xl'>
        ...
        <KeyboardVoiceIcon className='h-5'/>
      </div>
      <div className='flex flex-col space-y-2 justify-center mt-6 w-1/2 sm:space-y-0 sm:flex-row sm:space-x-4'>
